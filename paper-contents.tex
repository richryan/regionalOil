...
\begin{figure}[htbp]
  ...
  \resizebox{\textwidth}{!}{
  \input{./out/fig_plt_irf_oil_block_kern.tex}}
...
\begin{figure}[htbp]
  ...
  \input{./out/fig_plt_irf_empl_block_kern.tex}}
...
\begin{figure}[htbp]
  ...
  \input{./out//fig_plt_hd_components_kern.tex}}
...
\begin{figure}[htbp]
  ...
  % \resizebox{<horizontal size>}{<vertical size>}{%
  \resizebox{\textwidth}{!}{
  \input{./out//fig_plt_historical_counterfactual_kern_early.tex}}
...
\begin{figure}[htbp]
  ...
  % \resizebox{<horizontal size>}{<vertical size>}{%
  \resizebox{\textwidth}{!}{
  \input{./out/fig_plt_historical_counterfactual_kern_late.tex}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{\textwidth}{!}{
    \input{./out/fig_plt_irf2_wages.tex}
  }
...
\begin{figure}[htbp]
  ...
  % \resizebox{<horizontal size>}{<vertical size>}{%
  \resizebox{\textwidth}{!}{
  \input{./out/fig_plt_empl_share_oil_kern.tex}}
...
\begin{table}[h]
  ...
  \resizebox{\textwidth}{!}{
    \input{./out/tbl_counterfactual_empl_kern_early.tex}}
\end{table}
...
\begin{table}[h]
  ...
  \resizebox{\textwidth}{!}{
    \input{./out/tbl_counterfactual_empl_kern_late.tex}}
\end{table}

\input{./out/tbl_fevd_kern_dempl.tex}


\input{./out/tbl_fevd_kern_oilsupply.tex}


\input{./out/tbl_fevd_kern_rpoil.tex}
